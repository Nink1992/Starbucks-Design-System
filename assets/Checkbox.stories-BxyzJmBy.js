import{d as Z,b as i,e as C,n as c,u as m,f as y,g as H,j as J,k as g,o as u,l as K,t as Q,m as $}from"./vue.esm-bundler-5vuPSkAG.js";const t={"checkbox-wrapper":"_checkbox-wrapper_6u7dx_2","checkbox-box":"_checkbox-box_6u7dx_13","checkbox-icon":"_checkbox-icon_6u7dx_29","checkbox-dash-icon":"_checkbox-dash-icon_6u7dx_56","is-disabled":"_is-disabled_6u7dx_69","is-checked":"_is-checked_6u7dx_75","is-indeterminate":"_is-indeterminate_6u7dx_86"},R=["aria-checked","aria-disabled"],s=Z({__name:"Checkbox",props:{modelValue:{type:[Boolean,Array]},label:{},value:{type:[String,Number,Boolean]},disabled:{type:Boolean},indeterminate:{type:Boolean}},emits:["update:modelValue","change"],setup(e,{emit:l}){const a=e,d=l,n=g(()=>Array.isArray(a.modelValue)?a.modelValue.includes(a.value):!!a.modelValue),j=()=>{if(a.disabled)return;let o;if(Array.isArray(a.modelValue)){const r=[...a.modelValue];if(n.value){const f=r.indexOf(a.value);f>-1&&r.splice(f,1)}else r.push(a.value);o=r}else o=!a.modelValue;d("update:modelValue",o),d("change",o)},F=g(()=>({[t["checkbox-wrapper"]]:!0,[t["is-checked"]]:n.value,[t["is-indeterminate"]]:a.indeterminate,[t["is-disabled"]]:a.disabled}));return(o,r)=>(u(),i("label",{class:c(F.value),onClick:J(j,["prevent"]),role:"checkbox","aria-checked":e.indeterminate?"mixed":n.value,"aria-disabled":e.disabled},[C("span",{class:c(m(t)["checkbox-box"])},[n.value&&!e.indeterminate?(u(),i("svg",{key:0,class:c(m(t)["checkbox-icon"]),width:"10",height:"8",viewBox:"0 0 10 8",fill:"none",xmlns:"http://www.w3.org/2000/svg"},[...r[0]||(r[0]=[C("path",{d:"M3.66667 7.5L0.5 4.33333L1.66667 3.16667L3.66667 5.16667L8.33333 0.5L9.5 1.66667L3.66667 7.5Z",fill:"currentColor"},null,-1)])],2)):y("",!0),e.indeterminate?(u(),i("span",{key:1,class:c(m(t)["checkbox-dash-icon"])},null,2)):y("",!0)],2),e.label||o.$slots.default?(u(),i("span",{key:0,class:c(m(t)["checkbox-label"])},[H(o.$slots,"default",{},()=>[K(Q(e.label),1)])],2)):y("",!0)],10,R))}});s.__docgenInfo={exportName:"default",displayName:"Checkbox",description:"",tags:{},props:[{name:"modelValue",required:!1,type:{name:"union",elements:[{name:"boolean"},{name:"Array",elements:[{name:"any"}]}]}},{name:"label",required:!1,type:{name:"string"}},{name:"value",required:!1,type:{name:"union",elements:[{name:"string"},{name:"number"},{name:"boolean"}]}},{name:"disabled",required:!1,type:{name:"boolean"}},{name:"indeterminate",required:!1,type:{name:"boolean"}}],events:[{name:"update:modelValue",type:{names:["union"],elements:[{name:"boolean"},{name:"Array",elements:[{name:"any"}]}]}},{name:"change",type:{names:["union"],elements:[{name:"boolean"},{name:"Array",elements:[{name:"any"}]}]}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/Starbucks-Design-System/Starbucks-Design-System/Checkbox/Checkbox.vue"]};const W={title:"数据录入/复选框 Checkbox",component:s,tags:["autodocs"],parameters:{docs:{description:{component:'<span style="font-size: 14px; color: #666;">复选框用于在一组可选项中进行多项选择。</span>'}}},argTypes:{modelValue:{control:"boolean"},label:{control:"text"},disabled:{control:"boolean"},indeterminate:{control:"boolean"}}},p={name:"默认复选框",args:{modelValue:!1,label:"Checkbox"},render:e=>({components:{TraeCheckbox:s},setup(){return{args:e}},template:'<TraeCheckbox v-bind="args" v-model="args.modelValue" />'})},b={args:{modelValue:!0,label:"Checked"},render:e=>({components:{TraeCheckbox:s},setup(){return{args:e}},template:'<TraeCheckbox v-bind="args" v-model="args.modelValue" />'})},h={name:"禁用状态",args:{modelValue:!0,label:"Disabled",disabled:!0}},k={args:{modelValue:!1,label:"Indeterminate",indeterminate:!0}},x={name:"复选框组",render:()=>({components:{TraeCheckbox:s},setup(){return{checkedList:$(["Apple"])}},template:`
    ...
    `})},v={render:()=>({components:{TraeCheckbox:s},setup(){const e=["选项一","选项二","选项三","选项四"],l=$(["选项一","选项二"]),a=g({get:()=>l.value.length===e.length,set:n=>{l.value=n?[...e]:[]}}),d=g(()=>l.value.length>0&&l.value.length<e.length);return{options:e,checkedList:l,checkAll:a,isIndeterminate:d}},template:`
...
}`,...(O=(N=k.parameters)==null?void 0:N.docs)==null?void 0:O.source}}};var q,z,G;x.parameters={...x.parameters,docs:{...(q=x.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: '复选框组',
  render: () => ({
    components: {
      TraeCheckbox
...
}`,...(G=(z=x.parameters)==null?void 0:z.docs)==null?void 0:G.source}}};var P,E,M;v.parameters={...v.parameters,docs:{...(P=v.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: () => ({
    components: {
      TraeCheckbox
    },
